      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 px-6 text-left">
          ...
          <p className="text-gray-600 text-base leading-relaxed mb-4 font-axiformaBook">
            At Pimo-Mafuta Energies Limited, we are more than just an energy
            services company — we are innovators, problem-solvers, and industry
            leaders dedicated to shaping the future of energy. We understand the
